...
#
#######################################GP-UCB-REV###############################     
#        strFile=pickle_location+"\\{:s}_{:d}_Single_ucb_reverse.pickle".format(function_name,D)
#        with open(strFile,'rb') as f:
#
#            EI = pickle.load(f)
#            
...
#        myStd=myStd*std_scale
#
#        plt.errorbar(x_axis,-myYbest,yerr=myStd/np.sqrt(10),linewidth=mylinewidth,color='purple',linestyle='-',marker='h', label='GP-UCB Reversed')
#######################################GP-UCB-REV#END###########################   
